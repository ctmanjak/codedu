...
def create_post_like_schema():
    ...
    mutation_field["update_post_like"] = create_mutation_field("UpdatePostLike",
        gql_models['post_like'],
        update_post_like_mutate,
        create_input_class('UpdatePostLikeInput', {
